package com.mapzen.tangram.demos.multimap;
...
import com.mapzen.tangram.demos.simplemap.BuildConfig;
import com.mapzen.tangram.demos.simplemap.R;

import java.util.ArrayList;
import java.util.List;

public class MainActivity extends AppCompatActivity implements TouchInput.RotateResponder {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewTop.getMapAsync(new MapView.MapReadyCallback() {
            ...
            public void onMapReady(@Nullable MapController mapController) {
                ...
                MainActivity.this.onMapReady(mapController);
            }
        });
